...
- Exception: in GitHub Actions one-shot runs, do not finish with pending background tasks. Prefer synchronous work or collect background results before any final comment.
